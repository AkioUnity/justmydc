		...
		<div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">				  
					...
					<form role="form" action="<?php echo base_url(); ?>categories/updateSecCategories?Id=<?php echo $categories['id'];?>&&parent_id=<?php echo $_GET['parent_id'];?>&&name=<?php echo $_GET['name']?>" enctype="multipart/form-data" method="post" onsubmit="return CategoryVaildation();"/>
