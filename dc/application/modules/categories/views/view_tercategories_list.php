            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tertiary Category List (<?php echo $_GET['name'];?>)</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="dataTables_length" id="example1_length">
							    ...
							    <button  type="button" class="btn btn-info" style="float:right;" onclick="window.location.href='<?php echo base_url(); ?>categories/addTercategories?parent_id=<?php echo $this->input->get('id');?>&&name=<?php echo $_GET['name']?>'" />Add Tertiary Categories</button>
							</div>
						</div>
					</form>
					</div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php $i=1; foreach($c_categories as $c_categories): ?>
                      ...
                      <tr>
						...
						<td>
							<a href="<?php echo base_url(); ?>categories/editTercategories?id=<?php echo $c_categories['id'] ?>&&parent_id=<?php echo $this->input->get('id');?>&&name=<?php echo $_GET['name']?>">
