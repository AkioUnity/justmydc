                            ...
                            <div class="col-sm-12">
                                <div class="dataTables_length" id="example1_length">
                                    ...
                                    <button type="button" class="btn btn-info" style="float:right;"
                                            onclick="window.location.href='<?php echo base_url(); ?>categories/addSubcategories?parent_id=<?php echo $this->input->get('id'); ?>&&name=<?php echo $_GET['name'] ?>'"/>
...
<!--                                <td>--><?php //echo $c_categories['spotlight'] ? 'spotlight' : ''; ?><!--</td>-->
