		...
		<div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header" style="background-color: rgba(19, 17, 17, 0.21);">
                  <h3 class="box-title">Add Tertiary Category (<?php echo $_GET['name'];?>)</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
			    ...
			    <div class="box-body">
					<form  action="<?php echo base_url();?>categories/insertTercategories?parent_id=<?php echo $this->input->get('parent_id') ?>&&name=<?php echo $_GET['name']?>" method="post" enctype="multipart/form-data" onsubmit="return CategoryVaildation();">
						<div class="row">
