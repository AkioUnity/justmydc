					...
					<div class="row">
						...
						<div class="col-sm-12">
							<div class="dataTables_length" id="example1_length">
							    ...
							    <button  type="button" class="btn btn-info" style="float:right;" onclick="window.location.href='<?php echo base_url(); ?>categories/addPrimeryCategory'" />Add Category</button>
							</div>
						</div>
					</form>
					</div>
