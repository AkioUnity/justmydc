                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <?php if ($profileMedia['pm_file_path']) { ?>
                                        <a href="<?php echo base_url() . 'upload/profile/' . $profileMedia['pm_file_path']; ?>"
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="media_url" class="form-control name_list"
                                           placeholder="Enter Url" value="<?php echo $profileMedia['pm_url']; ?>">
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 col-xs-6">
                                <div class="form-group">
                                    <label for="MediaTitle">Title</label>
                                    <input type="text" name="media_title" value="<?php echo $profileMedia['title']; ?>"
                                           class="form-control" id="MediaTitle" placeholder="Enter Title" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="content" class="form-control textbox" id="content"
                                              placeholder="Within 500 characters"><?php echo $profileMedia['content']; ?>
                                        "</textarea>
                                </div>
                            </div>
                        </div>
