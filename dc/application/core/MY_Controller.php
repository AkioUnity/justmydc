...
//        print_r($row);
        $this->default_market_id = $this->market['market_id'];
        $this->mViewData['market'] = $this->market;
        //-------menu
...
//			$this->mBaseUrl.= $language.'/';
    ...
    public function SetData($field)
    {
        if (isset($this->post_data[$field]))
            $this->update_data[$field] = $this->post_data[$field];
