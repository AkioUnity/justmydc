...
*/
$config['facebook_app_id']              = '894188074290085';
$config['facebook_app_secret']          = '8b8fa5f0ddbc8340ad51280dbed9d1e3';
...
$config['google_secret_id'] = 'hfqeBcmpD9lZ1hBcc1IqYoGo';
$config['google_call_back'] = base_url() . 'users/social_login/google_login/';

//$config['google_client_id']="402296166756-aakeumheliv24vkn7t8rp9ecrk36aj6i.apps.googleusercontent.com";
//$config['google_client_secret']="";
//$config['google_redirect_url']=base_url().'login/socialcallback';
