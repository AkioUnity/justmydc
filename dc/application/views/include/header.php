        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 text-center">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <ul class="sidebar-menu">
                    <li class="<?php if ($currPage == 'dashboard') {
                        echo 'active';
                    } ?>">
                    ...
                    <li class="<?php if ($currPage == 'orders') {
                        echo 'active';
                    } ?>">
                    ...
                    <li class="<?php if ($currPage == 'Packaging') {
                        echo 'active';
                    } ?>">
                    ...
                    <li class="<?php if ($currPage == 'Categoriesmanage') {
                        echo 'active';
                    } ?>">
                    ...
                    <li class="<?php if ($currPage == 'product') {
                        echo 'active';
                    } ?>">
                    ...
                    <li class="<?php if ($currPage == 'profile') {
                        echo 'active';
                    } ?>">
                    ...
                    <li class="<?php if ($currPage == 'section') {
                        echo 'active';
                    } ?>">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
            <div class="dataTables_length" id="example1_length" style="padding-top: 20px;">
                <button type="button" class="btn btn-info"
                        onclick="window.location.href='<?php echo base_url(); ?>login/logout'"/>
                Logout</button>
            </div>
        </div>
    </div>
