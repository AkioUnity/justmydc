...
<?php if (isset($spotlights) && sizeof($spotlights) > 0) { ?>
        ...
        <div class="carousel-inner">
            <?php for ($i = 0; $i < sizeof($spotlights); $i++) { ?>
                <div class="item <?php echo $i == 0 ? "active" : ""; ?>">
                    <?php if (isset($spotlights[$i]->cp_url)) { ?>
                    ...
                    <?php } else { ?>
                        <img src="<?php echo $spotlights[$i]->spotlight_image ?>"
                             alt="<?php echo $spotlights[$i]->spotlight_image ?>" style="width:100%;height: 38vw">
                    <?php } ?>
                </div>
            <?php } ?>
        </div>
